    ...
    <>
      <div className="flex flex-col items-center justify-center p-8">
        ...
        <Image
          ...
          height={114}
        />
        <div className={"font-bold text-2xl sm:text-[32px] mt-[50px]"}>
          {t("DigitalItemsInfo")}
        </div>
        <div className={"font-medium text-sm sm:text-[16px] mt-[100px]"}>
          {t("CreateFlowAccount")}
        </div>
        <input
          type={"text"}
          ...
          disabled={true}
          className={
            "rounded-lg bg-slate-100 w-full sm:w-[408px] h-[52px] mt-[10px] px-[15px] placeholder:text-center input-bordered shadow-[inset_0_2px_4px_0_rgb(0,0,0,0.3)]"
          }
        />
