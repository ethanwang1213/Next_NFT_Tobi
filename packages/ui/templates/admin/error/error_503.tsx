...
const ErrorPage_503 = () => {
  const e = useTranslations("error_503");
  return (
    <div className="flex min-h-screen justify-center items-center font-mplus px-4">
      <div className="w-screen md:w-[1000px] h-[600px] py-10 sm:p-0 flex md:flex-row justify-between">
        <div className="flex flex-col w-full md:w-1/2 relative">
          <img
            src="/admin/images/error/503_text.svg"
            alt="503 error"
          ...
          <div className="flex flex-col items-center mt-4">
            ...
            <div className="text-[3vw] md:text-[16px] mt-4 text-center">
              {e("content")}
            </div>
          </div>
          <div className="absolute bottom-[34px] left-0 w-full px-4">
            ...
            <div>
              <div className="text-[4vw] md:text-[18px] font-bold">
                {e("bottomTitle")}
              </div>
        ...
        <div className="flex flex-col justify-center w-full md:w-1/2">
          <img
            src="/admin/images/error/503.svg"
            alt="503 error"
