...
type Props = {
  user: User;
  onClickRegister: Dispatch<SetStateAction<boolean>>;
};

const FlowAgreement = ({ user, onClickRegister }: Props) => {
    ...
    <>
      <div className="flex flex-col items-center justify-center w-[100dvw] h-[100dvh] p-8">
        ...
        <button
          ...
          onClick={() => aboutLinkToFlowAccount.current.showModal()}
        >
          <div
        ...
        <div>
          ...
          <button
            ...
            onClick={() => termsDialogRef.current.showModal()}
          >
            利用規約
          </button>
      ...
      <AboutLinkToFlowAccount dialogRef={aboutLinkToFlowAccount} />
      <TermsOfService dialogRef={termsDialogRef} />
    </>
  );
};

const AboutLinkToFlowAccount = ({ dialogRef }) => {
  return (
...
const TermsOfService = ({ dialogRef }) => {
  return (
    <dialog ref={dialogRef} className="modal" style={{}}>
      <div className="modal-box overflow-hidden h-full p-0">
        <div className="overflow-auto h-full pt-[15px] pl-[15px] pr-[15px]">
