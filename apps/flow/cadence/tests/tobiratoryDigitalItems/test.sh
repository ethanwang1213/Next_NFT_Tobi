...
# View NFT Metadata
flow scripts execute ./cadence/scripts/tobiratoryDigitalItems/getMetadata.cdc 0x179b6b1cb6755e31 1
flow scripts execute ./cadence/scripts/tobiratoryDigitalItems/getMetadataTraits.cdc 0x179b6b1cb6755e31 1

# Update item name
flow transactions build ./cadence/transactions/tobiratoryDigitalItems/updateItemName.cdc \
    --args-json '[
        { "type": "UInt64", "value": "1" },
