...
transaction(name: String, description: String, imageURI: String) {
    ...
    execute {
        ...
        self.minter.mintTo(creator: self.receiver, metadata: {"name": name, "description": description, "imageURI": imageURI})
    }
}
