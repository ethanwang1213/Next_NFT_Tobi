...
pub contract HouseBadge: NonFungibleToken {
    ...
    pub fun createAdmin() {
        if self.account.borrow<&Admin>(from: /storage/HouseBadgeAdmin) == nil {
            self.account.save(<- create Admin(), to: /storage/HouseBadgeAdmin)
        }
    }
    ...
    init() {
        ...
        if self.account.borrow<&Admin>(from: /storage/HouseBadgeAdmin) == nil {
            ...
            self.account.save(<- admin, to: /storage/HouseBadgeAdmin)
        }
